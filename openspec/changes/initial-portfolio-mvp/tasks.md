...
- [ ] 3.1 RED/GREEN/REFACTOR `backend/app/domain/` retrieval/safety: Spanish normalization, stable score/top-k, allowed/unsupported/unsafe classification, provenance, thresholds, and limits. [Chat: supported, refusal, limits]
